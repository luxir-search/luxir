...
SOLUX_TD(PrefixQuery) SOLUX_TD(WildcardQuery) SOLUX_TD(RegexQuery) SOLUX_TD(FuzzyQuery) SOLUX_TD(PhraseQuery) SOLUX_TD(SimpleQuery) SOLUX_TD(RangeQuery)
...
SOLUX_ENTRY(PrefixQuery) SOLUX_ENTRY(WildcardQuery) SOLUX_ENTRY(RegexQuery) SOLUX_ENTRY(FuzzyQuery) SOLUX_ENTRY(PhraseQuery) SOLUX_ENTRY(SimpleQuery)
