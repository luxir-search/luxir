...
//
// Split out of luxir_types.hpp because glaze is expensive to parse (~1.5s of frontend per TU)
// and luxir_types.hpp is reached by nearly every engine TU through Schema.h / Query.h. Only
...
// only call the out-of-line luxir::api::read_json / write_json entry points do NOT need it.
//
...
// Luxir JSON dialect: hand from/to<JSON> overrides of the generated glz::meta
