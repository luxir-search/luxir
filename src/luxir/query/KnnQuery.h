...
class KnnQuery final : public luxir::Query {
...
public:
  ...
  public:
    std::unique_ptr<Query::Weight::PreparedWeight> prepare(Query::Weight::PrepareContext& ctx) override {
      ...
      if (metric == (int32_t)luxir::api::VectorMetric::COSINE) {
