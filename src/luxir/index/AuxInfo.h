...
//
// The wire type luxir::api::AuxIndexInfo is NON-OWNING (string_view / span / bytes_view),
...
inline AuxInfo fromWire(const luxir::api::AuxIndexInfo& w) {
  AuxInfo a;
...
inline luxir::api::AuxIndexInfo toWire(const AuxInfo& a, std::pmr::memory_resource& mr) {
  luxir::api::AuxIndexInfo w;
  w.kind = a.kind;
  w.field = a.field;
  w.name = a.name;
  w.gen = a.gen;
