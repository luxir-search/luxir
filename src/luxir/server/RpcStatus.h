...
// luxir.Error packed as the one detail, so generated clients can read a
...
inline constexpr std::string_view ERROR_TYPE_URL = "type.googleapis.com/luxir.Error";
...
// The inverse, for clients and tests: the first luxir.Error detail in
