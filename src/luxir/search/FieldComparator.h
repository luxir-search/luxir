...
public:
  ...
  LUXIR_NOINLINE int compareBottom(int32_t bottomSlot, segdoc bottomDoc, segdoc newDoc) override {
...
public:
  ...
  LUXIR_NOINLINE int compareBottom(int32_t bottomSlot, segdoc bottomDoc,
