...
public:
  ...
  void LUXIR_INLINE increment(int64_t ord) {
  ...
  void LUXIR_INLINE increment(int64_t ord, int64_t val) {
  ...
  // by the LUXIR_FACET_BYTES measurement hook.
  ...
  void LUXIR_NOINLINE merge(const SpanCounter& other) {
